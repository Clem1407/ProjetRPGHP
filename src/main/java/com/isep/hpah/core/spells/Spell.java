...
public class Spell extends AbstractSpell {
    ...
    static {
        ...
        spells.add(new Spell("Sectumsempra", "capable of causing severe physical harm to its target", 25, 0.7));
        spells.add(new Spell("expelliarmus", "used to disarm an opponent by causing their wand to fly out of their hand", 30, 0.8));
    }
}
